    ...
    <motion.div
      ...
      <motion.div
        ...
        animate={{
          background: isDark
            ? [
                `radial-gradient(circle at 30% 30%, rgba(229, 62, 62, ${
                  isHovered ? 0.25 : 0.15
                }) 0%, rgba(120, 119, 198, ${
                  isHovered ? 0.1 : 0.05
                }) 50%, transparent 80%)`,
                `radial-gradient(circle at 70% 70%, rgba(229, 62, 62, ${
                  isHovered ? 0.25 : 0.15
                }) 0%, rgba(120, 119, 198, ${
                  isHovered ? 0.1 : 0.05
                }) 50%, transparent 80%)`,
            ...
            : [
                `radial-gradient(circle at 30% 30%, ${
                  isHovered ? glowColor.replace("0.2", "0.3") : glowColor
                } 0%, transparent 70%)`,
      ...
      <motion.div
        ...
        style={{
          transformStyle: "preserve-3d",
          perspective: "1000px",
          transform: `rotateX(${rotateX.get()}deg) rotateY(${rotateY.get()}deg) scale(${
            isHovered ? 1.03 : 1
          })`,
