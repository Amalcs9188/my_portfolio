...
export default function AboutUs1() {
  const aboutData = {
    ...
    vision:
      'I envision a web where stunning, accessible, and performant applications are the standard — where technology feels effortless, and great user experiences are built by developers who care deeply about both form and function',
